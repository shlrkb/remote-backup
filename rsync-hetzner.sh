...
ROPTS="--exclude public_html/var --exclude public_html/pub/media/mf_webp --exclude public_html/media/catalog/product/cache --exclude public_html/pub/media/catalog/product/cache"
